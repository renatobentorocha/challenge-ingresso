...
import { Image, SvgIcon } from './styles';

export default function Logo() {
  return (
    <SvgIcon>
      <use xlinkHref="#icon-logo">
        <Image viewBox="0 0 254 40" id="icon-logo">
          <title>B8C90185-CE85-4FC8-975D-4A7FEE266C4C</title>
          <desc>Created with sketchtool.</desc>

          <g id="logo-header" transform="translate(0.000000, -1.000000)">
            <g
            ...
            >
              <path
                id="logo-Fill-42"
                className="lt0"
                d="M24.5,1.1l-3-11.1L-10-1.6l3,11.1l0,0c1.9,0.4,3.5,1.8,4,3.8c0.5,2-0.2,4-1.6,5.2l0,0l3,11.1
			l31.5-8.4l-3-11.1c-1.9-0.4-3.5-1.8-4-3.8S23,2.4,24.5,1.1"
              />
              <path
                id="logo-Combined-Shape"
                className="lt1"
                d="M38.1,21h4.5V4h-4.5V21z M37.6-0.6c0-1.5,1.2-2.6,2.7-2.6C41.8-3.2,43-2,43-0.6
          ...
          <path
            className="lt2"
            d="M24,9.7c0,2.3-1.8,4.1-4.1,4.1c-2.3,0-4.1-1.9-4.1-4.1c0-2.3,1.8-4.1,4.1-4.1C22.2,5.5,24,7.4,24,9.7"
          />
          <path
            className="lt2"
